        ...
        if (empty($nom) || empty($prenom) || empty($email)) {
            ...
            try {
                ...
                if ($stmt->fetch()) {
                    ...
                    $sql = "UPDATE utilisateurs SET nom = ?, prenom = ?, email = ?, telephone = ?, adresse = ?, ville = ?, code_postal = ? WHERE id = ?";
                    $stmt = $pdo->prepare($sql);
                    $stmt->execute([$nom, $prenom, $email, $telephone, $adresse, $ville, $code_postal, $_SESSION['user_id']]);
    ...
    <form method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="adresse" class="form-control"
                   ...
                   value="<?php echo escape($user['adresse'] ?? ''); ?>">
        </div>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" name="code_postal" class="form-control"
                       ...
                       value="<?php echo escape($user['code_postal'] ?? ''); ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="ville" class="form-control"
                       ...
                       value="<?php echo escape($user['ville'] ?? ''); ?>">
            </div>
        </div>
