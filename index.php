...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nom) || empty($prenom) || empty($email) || empty($password)) {
        ...
        if ($stmt->fetch()) {
            ...
            $stmt = $pdo->prepare("INSERT INTO utilisateurs (nom, prenom, email, password, role, statut) VALUES (?, ?, ?, ?, 'client', 'actif')");
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .login-link p { color: #666; font-size: 14px; }
        .login-link a {
            color: #667eea;
            text-decoration: none;
            font-weight: 600;
    ...
    <div class="form-container">
        ...
        <div class="form-content">
                ...
                <div class="success-message">
                    ...
                    <div class="success-buttons">
                        <?php if ($redirect === 'demande' && $vehicule_id > 0): ?>
                            <a href="demande.php?vehicule_id=<?php echo $vehicule_id; ?>" class="btn btn-primary">Continuer ma demande</a>
                        <?php else: ?>
            ...
            <?php else: ?>
                ...
                <?php if ($redirect === 'demande' && $vehicule_id > 0): ?>
                    <div class="info-box">
                        <p>🔒 <strong>Compte requis</strong><br>Créez un compte gratuit pour faire une demande d'achat. Vous serez ensuite redirigé automatiquement.</p>
                    </div>
                <?php else: ?>
                    <div class="info-box">
                ...
                <form method="POST" action="">
                    ...
                    <div class="login-link">
                        <p>Vous avez déjà un compte ?
                            <a href="login.php<?php echo ($redirect === 'demande' && $vehicule_id > 0) ? '?action=demande&vehicule_id=' . $vehicule_id : ''; ?>">Se connecter</a>
                        </p>
                    </div>
                </form>
            <?php endif; ?>
