...
if (!$est_client) {
    ...
    <div class="container">
        <div class="public-card public-card--centered">
            ...
            <p>Vous êtes connecté en tant que <strong><?php echo htmlspecialchars(ucfirst($_SESSION['role'])); ?></strong>.
...
$page_title = 'Demande d\'achat - ' . $vehicule['marque'] . ' ' . $vehicule['modele'];
$additional_css = ['assets/css/demande.css'];
include 'includes/header-client.php';
?>

<div class="page-wrapper">
    <a href="<?php echo appUrl('catalogue.php'); ?>" class="btn-back">
        ← Retour au catalogue
    </a>
        ...
        <div class="form-header">
            ...
            <div class="vehicule-summary">
                ...
                <div class="vehicule-summary-info">
                    ...
                    <div class="summary-item">
                        <span>⛽</span>
                        <span><?php echo htmlspecialchars(ucfirst($vehicule['carburant'])); ?></span>
                    </div>
                    <div class="summary-item">
                        <span>🛣️</span>
        ...
        <div class="form-content">
            <?php if ($success): ?>
                <div class="success-message">
                    ...
                    <div class="success-buttons">
                        <a href="<?php echo appUrl('catalogue.php'); ?>" class="btn btn-primary">← Retour au catalogue</a>
                        <a href="<?php echo appUrl('modules/clients/mes-demandes.php'); ?>" class="btn btn-secondary">Voir mes demandes</a>
                    </div>
                </div>
            <?php else: ?>
                <?php if ($error): ?>
                ...
                <form method="POST" action="">
                    <?php if (!$has_phone): ?>
                        <div class="form-group">
                            <label for="telephone">
                                Votre téléphone <span class="required">*</span>
                            </label>
                            <input type="tel" id="telephone" name="telephone" class="form-input" required placeholder="Ex: 0612345678">
                        </div>
                    <?php endif; ?>

                    <div class="form-group">
                        <label for="message">
                            Votre message <span class="optional">(optionnel)</span>
                        </label>
                        <textarea id="message" name="message" class="form-textarea" rows="5" placeholder="Précisez vos questions, disponibilités pour un essai, conditions de financement souhaitées..."><?php echo isset($_POST['message']) ? htmlspecialchars($_POST['message']) : ''; ?></textarea>
                    </div>
