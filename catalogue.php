...
$page_title = 'Catalogue Véhicules';
$additional_css = ['assets/css/catalogue-moderne.css'];
...
?>
    ...
    <div class="page-header" style="background: white; border-radius: 15px; padding: 2rem; margin-bottom: 2rem; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
        <div>
            <h1 style="color: var(--dark); margin: 0;">🚗 Catalogue Véhicules
                <span class="count-badge" style="background: var(--primary); color: white; padding: 0.5rem 1rem; border-radius: 20px; font-size: 0.9rem; margin-left: 1rem;"><?php echo count($vehicules); ?> disponibles</span>
            </h1>
            <p style="color: #666; margin-top: 0.5rem; margin-bottom: 0;">Découvrez notre sélection premium</p>
        </div>
    </div>
...
<!-- JavaScript spécifique au catalogue -->
<script src="<?php echo appUrl('assets/js/catalogue.js'); ?>"></script>

<script>
    // Animation au scroll des cartes de véhicules
